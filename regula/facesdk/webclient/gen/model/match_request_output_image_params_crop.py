...
class MatchRequestOutputImageParamsCrop(object):
    ...
    def return_original_rect(self):
        ...
        Whether to return the coordinates of the rectangle with the face in the original image prepared for the face crop. Can be used only if the face in the original image is not tilted.  # noqa: E501
    ...
    def type(self):
        ...
        The aspect ratio according to which face alignment is performed. See the [FaceImageQualityAlignType enum](https://docs.regulaforensics.com/develop/face-sdk/web-service/development/enums/face-image-quality-align-type/). To get a thumbnail with dimensions 3x4, set `0`.  # noqa: E501
