...
class DetectRequestAttributes(object):
    ...
    def __init__(self, config=None, local_vars_configuration=None):  # noqa: E501
        """DetectRequestAttributes - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def config(self):
        """Gets the config of this DetectRequestAttributes.  # noqa: E501


        :return: The config of this DetectRequestAttributes.  # noqa: E501
    ...
    def config(self, config):
        """Sets the config of this DetectRequestAttributes.


        :param config: The config of this DetectRequestAttributes.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetectRequestAttributes):
            return False
