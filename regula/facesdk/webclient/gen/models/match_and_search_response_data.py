...
class MatchAndSearchResponseData(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchAndSearchResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchAndSearchResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "results": [MatchImageResult.from_dict(_item) for _item in obj.get("results", []) if MatchImageResult.from_dict(_item) is not None],
            "elapsedTime": obj.get("elapsedTime"),
            "metadata": obj.get("metadata"),
            "detections": [MatchAndSearchResponseDataDetectionsItem.from_dict(_item) for _item in obj.get("detections", []) if MatchAndSearchResponseDataDetectionsItem.from_dict(_item) is not None]
        })
        return _obj
