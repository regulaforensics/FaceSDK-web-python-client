...
class GroupApi(object):
    ...
    def update_group(self, group_id, body, **kwargs):  # noqa: E501
        ...
        :param group_id: Group id (required)
        :type group_id: float
        :param body: Update group (required)
        :type body: Model1groups1groupId
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def update_group_with_http_info(self, group_id, body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('body' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `body` when calling `update_group`")  # noqa: E501
