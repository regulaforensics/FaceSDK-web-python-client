...
from regula.facerecognition.webclient.gen.exceptions import ApiTypeError, ApiValueError, ApiException
from regula.facerecognition.webclient.gen.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = MatchingApi()
        api_instance.compare  # this is an instance of the class Endpoint
        api_instance.compare()  # this invokes api_instance.compare.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.compare.callable or self.callable in this class
